# Threadsmith Adapter: Generic Agent
...
## Purpose
Operate as a provider-neutral agent that can read files and follow text instructions. Treat Threadsmith state as the coordination ledger.
